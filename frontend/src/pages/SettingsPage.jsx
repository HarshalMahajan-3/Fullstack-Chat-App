...
const PREVIEW_MESSAGES = [
  { id: 1, content: "Hey! Virat how are you?", isSent: false },
  { id: 2, content: "I'm super well. What about you?", isSent: true },
]
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className='font-medium text-sm'>Anushka</h3>
                      <p className='text-xs text-base-content/70'>Online</p>
                    </div>
                  </div>
                </div>
                {/* Chat Messages */}
                <div className="p-3 space-y-3 overflow-y-auto bg-base-100">
                  {PREVIEW_MESSAGES.map((message) => (
                    ...
                    >
                      <div
                        className={`chat-bubble max-w-[80%] rounded-xl p-3 shadow-sm ${message.isSent ? "bg-primary text-primary-content" : "bg-base-200"}`}
                      >
