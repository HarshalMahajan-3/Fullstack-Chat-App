  ...
  return (
    <div className='w-full flex flex-1 flex-col items-center justify-center p-8 sm:p-16 bg-base-100/50'>
      <div className="max-w-md text-center space-y-4 sm:space-y-6">
        ...
        {/* Welcome Text */}
        <h2 className='text-xl sm:text-2xl font-bold'>Welcome to Messenger!</h2>
        <p className="text-xs min-[470px]:text-sm sm:text-base text-base-content/60">Select a conversation from the sidebar to start chatting</p>
      </div>
    </div>
  )
}
